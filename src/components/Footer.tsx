...
export default function Footer() {
  ...
  const navigationLinks = [
    ...
    { name: "Tokenized Mechanism", id: "how-it-works" },
    { name: "Why BitStock", id: "why-bitstock" },
  ...
  return (
    <footer className="bg-foreground text-white">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                <Image src="/icon.png" alt="BitStock" width={32} height={32} />
                <span className="font-heading text-2xl font-bold text-white">
                  BitStock
                </span>
              </div>
              <p className="font-body text-silver-light mb-6 leading-relaxed max-w-md">
                The secure bridge between cryptocurrency and traditional equities. 
                Trade real U.S. stocks with your crypto, backed 1:1 by SEC-registered custodians.
              </p>
                  ...
                  <a
                    ...
                    className={`transition-colors duration-200 ${
                      item.href 
                        ...
                        : 'text-silver-dark cursor-not-allowed opacity-50'
                    }`}
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                {navigationLinks.map((item) => (
                  <button
                    ...
                    className="font-body text-silver-light hover:text-white transition-colors duration-200 text-left hover:cursor-pointer"
                  >
                    {item.name}
                  </button>
                ))}
        ...
        {/* Bottom bar */}
        <div className="border-t border-silver-dark py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="font-body text-silver-light text-sm">
              © {new Date().getFullYear()} BitStock. All rights reserved.
            </p>
